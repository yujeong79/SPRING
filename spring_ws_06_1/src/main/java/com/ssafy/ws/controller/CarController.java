...
public class CarController {
	 ...
	 */
	@PostMapping("/regist")
	public String doRegist(@ModelAttribute Car car, @RequestPart(value="file", required = false) @RequestParam("file") MultipartFile file) throws IllegalStateException, IOException {
