...
public class UserController {
	 ...
	 */
	@PostMapping("/regist")
	public String doRegist(@ModelAttribute User user, @RequestPart(value="file", required = false) @RequestParam("file") MultipartFile file , Model model) throws IllegalStateException, IOException {
