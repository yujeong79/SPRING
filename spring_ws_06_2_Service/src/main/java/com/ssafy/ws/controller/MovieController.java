...
import com.ssafy.ws.model.service.MovieServiceImpl;
...
public class MovieController {
	 ...
	 */
	@PostMapping("/regist")
	public String doRegist(@ModelAttribute Movie movie, @RequestPart(value="file", required = false) @RequestParam("file") MultipartFile file) throws IllegalStateException, IOException {
